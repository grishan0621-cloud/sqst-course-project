...
## 2. Hard-coded API_TOKEN — False Positive

| Поле          | Значение                                                |
|---------------|---------------------------------------------------------|
| Правило       | python:S2068 (Vulnerability, MAJOR)                     |
| Файл          | backend/app.py:33 (`API_TOKEN = "tok_prod_abc123xyz"`)  |
| Решение       | False Positive                                          |
| Обоснование   | Похоже на тестовое значение — скорее всего ложное срабатывание. |
| Дата          | 2026-05-13                                              |
